package Kawbs::Device::ELM327;

# based 99.9999% on the original version by Alister Perrott.
# See https://metacpan.org/pod/Device::ELM327  v0.14
#
# perltidied and slightly modified by Karl Hoskin
# So many thanks from me (Karl Hoskin) for a very useful perl module.
...
# karl hoskin, changed verion number :
our $VERSION = '0.14.1';
...
sub new {
    ...
    $self->{'response_length'} =
      0;                       # Total number of characters in the response.
    $self->{'results'} = {};
    ...
    $self->{'status_meanings'} = {
        ...
        "General Reject" =>
          "Service was rejected. ECU did not specify the reason",
        "Service Not Supported" =>
          "The ECU does not support the requested service",
        "Sub Function Not Supported - Invalid Format" =>
"The ECU does not support the arguments of the request message or the format of the argument bytes do not match the prescribed format for the service",
        "Busy - Repeat Request" =>
          "The ECU is temporarily too busy to perform the requested operation",
        "Conditions Not Correct or Request Sequence Error" =>
"ECU prerequisite conditions not met. Have commands been issued in the correct order?",
        "Request Correctly Received - Response Pending" =>
"Correct command and parameters received, but ECU is busy. Response will follow.",
    };
...
# Negative response codes (received with a 7F Negative Response Service Identifier)
    ...
    $self->{'Standardized_Test_IDs'} = {
        ...
        "3" => {
            name => "Low sensor voltage for switch time calculation (constant)"
        },
        "4" => {
            name => "High sensor voltage for switch time calculation (constant)"
        },
        ...
        "11" => {
            name =>
"Exponential Weighted Moving Average misfire counts for last ten driving cycles"
        },
    ...
    $self->{'unit_and_scaling_identifiers'} = {
        ...
        "5" =>
          { description => "Raw Value", modifier => "*0.0000305", unit => "" },
        "6" =>
          { description => "Raw Value", modifier => "*0.000305", unit => "" },
        "7" => {
        ...
        "10" =>
          { description => "Voltage", modifier => "*0.000122", unit => "V" },
        "11" => { description => "Voltage", modifier => "/1000", unit => "V" },
        "12" => { description => "Voltage", modifier => "/100",  unit => "V" },
        "13" =>
          { description => "Current", modifier => "*0.00390625", unit => "mA" },
        "14" =>
          { description => "Current", modifier => "*0.001", unit => "mA" },
        ...
        "19" =>
          { description => "Resistance", modifier => "/1000", unit => "Ohm" },
        "20" =>
          { description => "Resistance", modifier => "/1000", unit => "kOhm" },
        "21" =>
          { description => "Resistance", modifier => "+0", unit => "kOhm" },
        "22" =>
          { description => "Temperature", modifier => "/10-40", unit => "°C" },
        "23" => {
        ...
        "24" => {
            description => "Pressure (Air pressure)",
            modifier    => "*0.0117",
            unit        => "kPa"
        },
        "25" => {
            description => "Pressure (Fuel pressure)",
            modifier    => "*0.079",
            unit        => "kPa"
        },
        "26" => {
        ...
        "27" => {
            description => "Pressure (Diesel pressure)",
            modifier    => "*10",
            unit        => "kPa"
        },
        ...
        "30" => {
            description => "Equivalence ratio (lambda)",
            modifier    => "*0.0000305",
            unit        => "lambda"
        },
        "31" => {
        ...
        "32" =>
          { description => "Ratio", modifier => "*0.0039062", unit => "" },
        "33" =>
          { description => "Frequency", modifier => "/1000", unit => "Hz" },
        "34" => { description => "Frequency", modifier => "+0", unit => "Hz" },
        "35" =>
          { description => "Frequency", modifier => "/1000", unit => "MHz" },
        "36" => { description => "Counts", modifier => "+0", unit => "counts" },
        "37" => { description => "Distance", modifier => "+0", unit => "km" },
        "38" => {
            description => "Voltage per time",
            modifier    => "/1000",
            unit        => "V/ms"
        },
        "39" =>
          { description => "Mass per time", modifier => "/100", unit => "g/s" },
        "40" =>
          { description => "Mass per time", modifier => "+0", unit => "g/s" },
        "41" => {
            description => "Pressure per time",
            modifier    => "/1000",
            unit        => "kPa/s"
        },
        "42" => {
            description => "Mass per time",
            modifier    => "/1000",
            unit        => "kg/h"
        },
        "43" =>
          { description => "Switches", modifier => "+0", unit => "switches" },
        "44" => {
            description => "Mass per cylinder",
            modifier    => "/100",
            unit        => "g/cyl"
        },
        "45" => {
            description => "Mass per stroke",
            modifier    => "/100",
            unit        => "mg/stroke"
        },
        ...
        "48" =>
          { description => "Percent", modifier => "*0.001526", unit => "%" },
        "49" => { description => "volume", modifier => "/1000", unit => "L" },
        "50" =>
          { description => "length", modifier => "*0.0007747", unit => "mm" },
        "51" => {
            description => "Equivalence ratio (lambda)",
            modifier    => "*0.00024414",
            unit        => "lambda"
        ...
        "132" =>
          { description => "Raw Value", modifier => "/1000", unit => "" },
        "133" =>
          { description => "Raw Value", modifier => "*0.0000305", unit => "" },
        "134" =>
          { description => "Raw Value", modifier => "*0.000305", unit => "" },
        ...
        "150" =>
          { description => "Temperature", modifier => "/10", unit => "°C" },
        ...
        "176" =>
          { description => "Percent", modifier => "*0.003052", unit => "%" },
        "177" => {
            description => "Voltage per time",
            modifier    => "*2",
            unit        => "V/ms"
    ...
    $self->{'get'} = {
        ...
        "Input Voltage" => {
            command   => "AT RV",
            available => 1,
            result => [ { type => "AT", modifier => '=~ s/V//', unit => "V" } ]
        },
        "Ignition state" => {
            command   => "AT IGN",
            available => 1,
...
#            {name => "DTC that caused required freeze frame data storage", type => "bool_0", modifier => "&64", unit => ""},
                ...
                {
                    name     => "Short Term Fuel Trim - Bank 1/3",
                    type     => "bool_0",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Long Term Fuel Trim - Bank 1/3",
                    type     => "bool_0",
                    modifier => "&2",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Short Term Fuel Trim - Bank 2/4",
                    type     => "bool_0",
                    modifier => "&1",
                    unit     => "not supported,supported"
                },
                ...
                {
                    name     => "Long Term Fuel Trim - Bank 2/4",
                    type     => "bool_1",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                ...
                {
                    name     => "Location of oxygen sensors 13",
                    type     => "bool_2",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                ...
                {
                    name     => "Bank 3 - Sensor 2",
                    type     => "bool_3",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Bank 4 - Sensor 1",
                    type     => "bool_3",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Bank 4 - Sensor 2",
                    type     => "bool_3",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                ...
                {
                    name     => "Location of oxygen sensors 1D",
                    type     => "bool_3",
                    modifier => "&8",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Bank 2 - Sensor 1 1D",
                    type     => "bool_2",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Bank 2 - Sensor 2 1D",
                    type     => "bool_2",
                    modifier => "&2",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Bank 3 - Sensor 1",
                    type     => "bool_2",
                    modifier => "&1",
                    unit     => "not supported,supported"
                },
        ...
        "Monitor status since DTCs cleared" => {
            ...
            result  => [
                ...
                {
                    name     => "Malfunction Indicator Lamp (MIL) Status",
                    type     => "bool_0",
                    modifier => "&128",
                    unit     => "off,on"
                },
                ...
                {
                    name     => "Misfire monitoring complete",
                    type     => "bool_1",
                    modifier => "&16",
                    unit     => "not completed, completed"
                },
                {
                    name     => "Fuel system monitoring complete",
                    type     => "bool_1",
                    modifier => "&32",
                    unit     => "not completed, completed"
                },
                {
                    name     => "Comprehensive component monitoring complete",
                    type     => "bool_1",
                    modifier => "&64",
                    unit     => "not completed, completed"
                },
                ...
                {
                    name     => "Catalyst monitoring complete",
                    type     => "bool_3",
                    modifier => "&1",
                    unit     => "not completed, completed"
                },
                {
                    name     => "Heated catalyst monitoring complete",
                    type     => "bool_3",
                    modifier => "&2",
                    unit     => "not completed, completed"
                },
                {
                    name     => "Evaporative system monitoring complete",
                    type     => "bool_3",
                    modifier => "&4",
                    unit     => "not completed, completed"
                },
                {
                    name     => "Secondary air system monitoring complete",
                    type     => "bool_3",
                    modifier => "&8",
                    unit     => "not completed, completed"
                },
                {
                    name     => "A/C system refrigerant monitoring complete",
                    type     => "bool_3",
                    modifier => "&16",
                    unit     => "not completed, completed"
                },
                {
                    name     => "Oxygen sensor monitoring complete",
                    type     => "bool_3",
                    modifier => "&32",
                    unit     => "not completed, completed"
                },
                {
                    name     => "Oxygen sensor heater monitoring complete",
                    type     => "bool_3",
                    modifier => "&64",
                    unit     => "not completed, completed"
                },
                {
                    name     => "EGR system monitoring complete",
                    type     => "bool_3",
                    modifier => "&128",
                    unit     => "not completed, completed"
                },
...
"Closed loop, but fault with at least one oxygen sensor - may be using single oxygen sensor for fuel control"
        ...
        "Calculated LOAD Value!" => {
            command => "01 04",
            result =>
              [ { type => "byte_0", modifier => "*100/255", unit => "%" } ]
        },
        "Engine Coolant Temperature" => {
            command => "01 05",
            result => [ { type => "byte_0", modifier => "-40", unit => "°C" } ]
        },
        ...
        "Short Term Fuel Trim - Bank 1/3" => {
            ...
            result  => [
                ...
                {
                    name     => "Short Term Fuel Trim - Bank 3",
                    type     => "signed_byte_1",
                    modifier => "*100/128",
                    unit     => "%"
                },
        ...
        "Long Term Fuel Trim - Bank 1/3" => {
            ...
            result  => [
                ...
                {
                    name     => "Long Term Fuel Trim - Bank 3",
                    type     => "signed_byte_1",
                    modifier => "*100/128",
                    unit     => "%"
                },
        ...
        "Fuel Rail Pressure (gauge)" => {
            command => "01 0A",
            result  => [ { type => "byte_0", modifier => "*3", unit => "kPa" } ]
        },
        "Intake Manifold Absolute Pressure" => {
            command => "01 0B",
            result  => [ { type => "byte_0", modifier => "*1", unit => "kPa" } ]
        },
        "Engine RPM" => {
            command => "01 0C",
            result  => [ { type => "word_0", modifier => "/4", unit => "RPM" } ]
        },
        "Vehicle Speed Sensor" => {
            command => "01 0D",
            result => [ { type => "byte_0", modifier => "+0", unit => "km/h" } ]
        },
        "Ignition Timing Advance for #1 Cylinder" => {
            command => "01 0E",
            result =>
              [ { type => "signed_byte_0", modifier => "/2", unit => "°" } ]
        },
        ...
        "Air Flow Rate from Mass Air Flow Sensor" => {
            command => "01 10",
            result =>
              [ { type => "word_0", modifier => "/100", unit => "g/s" } ]
        },
            ...
            result  => [
                {
                    ...
                    alternatives => [
                        {
                            value   => 1,
                            meaning => "upstream of first catalytic converter"
                        },
                        {
                            value => 2,
                            meaning =>
        ...
        "Location of oxygen sensors 13" => {
            ...
            result  => [
                {
                    name     => "Bank 1 - Sensor 1 present",
                    type     => "bool_0",
                    modifier => "&1",
                    unit     => "not present,present"
                },
                {
                    name     => "Bank 1 - Sensor 2 present",
                    type     => "bool_0",
                    modifier => "&2",
                    unit     => "not present,present"
                },
                {
                    name     => "Bank 1 - Sensor 3 present",
                    type     => "bool_0",
                    modifier => "&4",
                    unit     => "not present,present"
                },
                {
                    name     => "Bank 1 - Sensor 4 present",
                    type     => "bool_0",
                    modifier => "&8",
                    unit     => "not present,present"
                },
                {
                    name     => "Bank 2 - Sensor 1 present",
                    type     => "bool_0",
                    modifier => "&16",
                    unit     => "not present,present"
                },
                {
                    name     => "Bank 2 - Sensor 2 present",
                    type     => "bool_0",
                    modifier => "&32",
                    unit     => "not present,present"
                },
                {
                    name     => "Bank 2 - Sensor 3 present",
                    type     => "bool_0",
                    modifier => "&64",
                    unit     => "not present,present"
                },
                {
                    name     => "Bank 2 - Sensor 4 present",
                    type     => "bool_0",
                    modifier => "&128",
                    unit     => "not present,present"
                }
        ...
        "Bank 1 - Sensor 1" => {
            ...
            result  => [
                {
                    name     => "Oxygen Sensor Output Voltage (Bx-Sy)",
                    type     => "byte_0",
                    modifier => "*0.005",
                    unit     => "V"
                },
                {
                    name     => "Short Term Fuel Trim (Bx-Sy)",
                    type     => "byte_1",
                    modifier => "*100/255",
                    unit     => "%"
                }
        ...
        "Location of oxygen sensors 1D" => {
            ...
            result  => [
                ...
                {
                    name     => "Bank 3 - Sensor 1 present",
                    type     => "bool_0",
                    modifier => "&16",
                    unit     => "not present,present"
                },
                {
                    name     => "Bank 3 - Sensor 2 present",
                    type     => "bool_0",
                    modifier => "&32",
                    unit     => "not present,present"
                },
                {
                    name     => "Bank 4 - Sensor 1 present",
                    type     => "bool_0",
                    modifier => "&64",
                    unit     => "not present,present"
                },
                {
                    name     => "Bank 4 - Sensor 2 present",
                    type     => "bool_0",
                    modifier => "&128",
                    unit     => "not present,present"
                },
        ...
        "Time Since Engine Start" => {
            command => "01 1F",
            result  => [ { type => "word_0", modifier => "*10", unit => "s" } ]
        },

        "01 PIDs supported (21-40)" => {
            command => "01 20",
            result  => [
                {
                    name     => "Distance Travelled While MIL is Activated",
                    type     => "bool_0",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                ...
                {
                    name     => "Bank 1 - Sensor 1 (wide range O2S)",
                    type     => "bool_0",
                    modifier => "&16",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Bank 1 - Sensor 2 (wide range O2S)",
                    type     => "bool_0",
                    modifier => "&8",
                    unit     => "not supported,supported"
                },
                ...
                {
                    name     => "Bank 1 - Sensor 3 (wide range O2S)",
                    type     => "bool_0",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Bank 1 - Sensor 4 (wide range O2S)",
                    type     => "bool_0",
                    modifier => "&2",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Bank 2 - Sensor 1 (wide range O2S) 13",
                    type     => "bool_0",
                    modifier => "&1",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Bank 2 - Sensor 1 (wide range O2S) 1D",
                    type     => "bool_0",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Bank 2 - Sensor 2 (wide range O2S) 1D",
                    type     => "bool_0",
                    modifier => "&2",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Bank 3 - Sensor 1 (wide range O2S)",
                    type     => "bool_0",
                    modifier => "&1",
                    unit     => "not supported,supported"
                },
                ...
                {
                    name     => "Bank 2 - Sensor 2 (wide range O2S) 13",
                    type     => "bool_1",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Bank 2 - Sensor 3 (wide range O2S)",
                    type     => "bool_1",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Bank 2 - Sensor 4 (wide range O2S)",
                    type     => "bool_1",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Bank 3 - Sensor 2 (wide range O2S)",
                    type     => "bool_1",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Bank 4 - Sensor 1 (wide range O2S)",
                    type     => "bool_1",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Bank 4 - Sensor 2 (wide range O2S)",
                    type     => "bool_1",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
...
"Number of warm-ups since diagnostic trouble codes cleared",
                ...
                {
                    name     => "Bank 1 - Sensor 1 (wide range O2S) current",
                    type     => "bool_2",
                    modifier => "&16",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Bank 1 - Sensor 2 (wide range O2S) current",
                    type     => "bool_2",
                    modifier => "&8",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Bank 1 - Sensor 3 (wide range O2S) current",
                    type     => "bool_2",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Bank 1 - Sensor 4 (wide range O2S) current",
                    type     => "bool_2",
                    modifier => "&2",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Bank 2 - Sensor 1 (wide range O2S) current 13",
                    type     => "bool_2",
                    modifier => "&1",
                    unit     => "not supported,supported"
                },
                ...
                {
                    name     => "Bank 2 - Sensor 1 (wide range O2S) current 1D",
                    type     => "bool_2",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Bank 2 - Sensor 2 (wide range O2S) current 1D",
                    type     => "bool_2",
                    modifier => "&2",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Bank 3 - Sensor 1 (wide range O2S) current",
                    type     => "bool_2",
                    modifier => "&1",
                    unit     => "not supported,supported"
                },
                ...
                {
                    name     => "Bank 2 - Sensor 2 (wide range O2S) current 13",
                    type     => "bool_3",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Bank 2 - Sensor 3 (wide range O2S) current",
                    type     => "bool_3",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Bank 2 - Sensor 4 (wide range O2S) current",
                    type     => "bool_3",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Bank 3 - Sensor 2 (wide range O2S) current",
                    type     => "bool_3",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Bank 4 - Sensor 1 (wide range O2S) current",
                    type     => "bool_3",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Bank 4 - Sensor 2 (wide range O2S) current",
                    type     => "bool_3",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
        ...
        "Distance Travelled While MIL is Activated" => {
            command => "01 21",
            result  => [ { type => "word_0", modifier => "+0", unit => "km" } ]
        },
        "Fuel Rail Pressure relative to manifold vacuum" => {
            command => "01 22",
            result =>
              [ { type => "word_0", modifier => "*0.079", unit => "kPa" } ]
        },
        "Fuel Rail Pressure" => {
            command => "01 23",
            result => [ { type => "word_0", modifier => "*10", unit => "kPa" } ]
        },
        ...
        "Bank 1 - Sensor 1 (wide range O2S)" => {
            ...
            result  => [
                {
                    name     => "Equivalence Ratio (lambda) (Bx-Sy)",
                    type     => "word_0",
                    modifier => "*0.0000305",
                    unit     => ""
                },
                {
                    name     => "Oxygen Sensor Voltage (Bx-Sy)",
                    type     => "word_1",
                    modifier => "*0.000122",
                    unit     => "V"
                }
        ...
        "Bank 1 - Sensor 2 (wide range O2S)" => {
            command => "01 25",
            result  => [
                {
                    name     => "Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Bank 1 - Sensor 3 (wide range O2S)" => {
            command => "01 26",
            result  => [
                {
                    name     => "Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Bank 1 - Sensor 4 (wide range O2S)" => {
            command => "01 27",
            result  => [
                {
                    name     => "Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Bank 2 - Sensor 1 (wide range O2S) 13" => {
            command => "01 28",
            result  => [
                {
                    name     => "Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Bank 2 - Sensor 2 (wide range O2S) 13" => {
            command => "01 29",
            result  => [
                {
                    name     => "Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Bank 2 - Sensor 3 (wide range O2S)" => {
            command => "01 2A",
            result  => [
                {
                    name     => "Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Bank 2 - Sensor 4 (wide range O2S)" => {
            command => "01 2B",
            result  => [
                {
                    name     => "Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Bank 2 - Sensor 1 (wide range O2S) 1D" => {
            command => "01 26",
            result  => [
                {
                    name     => "Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Bank 2 - Sensor 2 (wide range O2S) 1D" => {
            command => "01 27",
            result  => [
                {
                    name     => "Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Bank 3 - Sensor 1 (wide range O2S)" => {
            command => "01 28",
            result  => [
                {
                    name     => "Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Bank 3 - Sensor 2 (wide range O2S)" => {
            command => "01 29",
            result  => [
                {
                    name     => "Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Bank 4 - Sensor 1 (wide range O2S)" => {
            command => "01 2A",
            result  => [
                {
                    name     => "Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Bank 4 - Sensor 2 (wide range O2S)" => {
            command => "01 2B",
            result  => [
                {
                    name     => "Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Number of warm-ups since diagnostic trouble codes cleared" => {
            command => "01 30",
            result  => [ { type => "byte_0", modifier => "+0", unit => "" } ]
        },
        ...
        "Evap System Vapor Pressure" => {
            command => "01 32",
            result  => [
                { type => "signed_word_0", modifier => "*0.25", unit => "Pa" }
            ]
        },
        "Barometric Pressure" => {
            command => "01 33",
            result  => [ { type => "byte_0", modifier => "+0", unit => "kPa" } ]
        },

        "Bank 1 - Sensor 1 (wide range O2S) current" => {
            command => "01 34",
            result  => [
                {
                    name     => "Equivalence Ratio (lambda) (Bx-Sy)",
                ...
                {
                    name     => "Oxygen Sensor Current (Bx-Sy)",
                    type     => "signed_word_1",
                    modifier => "*0.000122",
                    unit     => "A"
                }
        ...
        "Bank 1 - Sensor 2 (wide range O2S) current" => {
            command => "01 35",
            result  => [
                {
                    name     => "Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Bank 1 - Sensor 3 (wide range O2S) current" => {
            command => "01 36",
            result  => [
                {
                    name     => "Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Bank 1 - Sensor 4 (wide range O2S) current" => {
            command => "01 37",
            result  => [
                {
                    name     => "Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Bank 2 - Sensor 1 (wide range O2S) current 13" => {
            command => "01 38",
            result  => [
                {
                    name     => "Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Bank 2 - Sensor 2 (wide range O2S) current 13" => {
            command => "01 39",
            result  => [
                {
                    name     => "Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Bank 2 - Sensor 3 (wide range O2S) current" => {
            command => "01 3A",
            result  => [
                {
                    name     => "Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Bank 2 - Sensor 4 (wide range O2S) current" => {
            command => "01 3B",
            result  => [
                {
                    name     => "Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Bank 2 - Sensor 1 (wide range O2S) current 1D" => {
            command => "01 36",
            result  => [
                {
                    name     => "Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Bank 2 - Sensor 2 (wide range O2S) current 1D" => {
            command => "01 37",
            result  => [
                {
                    name     => "Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Bank 3 - Sensor 1 (wide range O2S) current" => {
            command => "01 38",
            result  => [
                {
                    name     => "Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Bank 3 - Sensor 2 (wide range O2S) current" => {
            command => "01 39",
            result  => [
                {
                    name     => "Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Bank 4 - Sensor 1 (wide range O2S) current" => {
            command => "01 3A",
            result  => [
                {
                    name     => "Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Bank 4 - Sensor 2 (wide range O2S) current" => {
            command => "01 3B",
            result  => [
                {
                    name     => "Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Catalyst Temperature Bank 1, Sensor 1" => {
            command => "01 3C",
            result =>
              [ { type => "word_0", modifier => "/10-40", unit => "°C" } ]
        },
        ...
        "01 PIDs supported (41-60)" => {
            ...
            result  => [
                ...
                {
                    name     => "Minutes run by the engine while MIL activated",
                    type     => "bool_1",
                    modifier => "&8",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Time since diagnostic trouble codes cleared",
                    type     => "bool_1",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                ...
                {
                    name => "Short Term Secondary O2 Sensor Fuel Trim - Bank 3",
                    type => "bool_2",
                    modifier => "&8",
                    unit     => "not supported,supported"
                },
                {
                    name => "Long Term Secondary O2 Sensor Fuel Trim - Bank 3",
                    type => "bool_2",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                {
                    name => "Short Term Secondary O2 Sensor Fuel Trim - Bank 4",
                    type => "bool_2",
                    modifier => "&2",
                    unit     => "not supported,supported"
                },
                {
                    name => "Long Term Secondary O2 Sensor Fuel Trim - Bank 4",
                    type => "bool_2",
                    modifier => "&1",
                    unit     => "not supported,supported"
                },
...
#            {name => "01 PIDs supported (61-80)", type => "bool_3", modifier => "&1", unit => "not supported,supported"},
        ...
        "Monitor status this driving cycle" => {
            ...
            result  => [
                {
                    name     => "Misfire monitoring Enable Status",
                    type     => "bool_1",
                    modifier => "&1",
                    unit     => "not enabled,enabled"
                },
                {
                    name     => "Fuel system monitoring Enable Status",
                    type     => "bool_1",
                    modifier => "&2",
                    unit     => "not enabled,enabled"
                },
                {
                    name => "Comprehensive component monitoring Enable Status",
                    type => "bool_1",
                    modifier => "&4",
                    unit     => "not enabled,enabled"
                },
                {
                    name     => "Misfire monitoring Completion Status",
                    type     => "bool_1",
                    modifier => "&16",
                    unit     => "not completed,completed"
                },
                {
                    name     => "Fuel system monitoring Completion Status",
                    type     => "bool_1",
                    modifier => "&32",
                    unit     => "not completed,completed"
                },
                {
                    name =>
                      "Comprehensive component monitoring Completion Status",
                    type     => "bool_1",
                    modifier => "&64",
                    unit     => "not completed,completed"
                },
                {
                    name     => "Catalyst monitoring Enable Status",
                    type     => "bool_2",
                    modifier => "&1",
                    unit     => "not enabled,enabled"
                },
                {
                    name     => "Heated catalyst monitoring Enable Status",
                    type     => "bool_2",
                    modifier => "&2",
                    unit     => "not enabled,enabled"
                },
                {
                    name     => "Evaporative system monitoring Enable Status",
                    type     => "bool_2",
                    modifier => "&4",
                    unit     => "not enabled,enabled"
                },
                {
                    name     => "Secondary air system monitoring Enable Status",
                    type     => "bool_2",
                    modifier => "&8",
                    unit     => "not enabled,enabled"
                },
                {
                    name => "A/C system refrigerant monitoring Enable Status",
                    type => "bool_2",
                    modifier => "&16",
                    unit     => "not enabled,enabled"
                },
                {
                    name     => "Oxygen sensor monitoring Enable Status",
                    type     => "bool_2",
                    modifier => "&32",
                    unit     => "not enabled,enabled"
                },
                {
                    name     => "Oxygen sensor heater monitoring Enable Status",
                    type     => "bool_2",
                    modifier => "&64",
                    unit     => "not enabled,enabled"
                },
                {
                    name     => "EGR monitoring Enable Status",
                    type     => "bool_2",
                    modifier => "&128",
                    unit     => "not enabled,enabled"
                },
                {
                    name     => "Catalyst monitoring Completion Status",
                    type     => "bool_3",
                    modifier => "&1",
                    unit     => "not completed,completed"
                },
                {
                    name     => "Heated catalyst monitoring Completion Status",
                    type     => "bool_3",
                    modifier => "&2",
                    unit     => "not completed,completed"
                },
                {
                    name => "Evaporative system monitoring Completion Status",
                    type => "bool_3",
                    modifier => "&4",
                    unit     => "not completed,completed"
                },
                {
                    name => "Secondary air system monitoring Completion Status",
                    type => "bool_3",
                    modifier => "&8",
                    unit     => "not completed,completed"
                },
                {
                    name =>
                      "A/C system refrigerant monitoring Completion Status",
                    type     => "bool_3",
                    modifier => "&16",
                    unit     => "not completed,completed"
                },
                {
                    name     => "Oxygen sensor monitoring Completion Status",
                    type     => "bool_3",
                    modifier => "&32",
                    unit     => "not completed,completed"
                },
                {
                    name => "Oxygen sensor heater monitoring Completion Status",
                    type => "bool_3",
                    modifier => "&64",
                    unit     => "not completed,completed"
                },
                {
                    name     => "EGR monitoring Completion Status",
                    type     => "bool_3",
                    modifier => "&128",
                    unit     => "not completed,completed"
                }
        ...
        "Control Module Voltage" => {
            command => "01 42",
            result =>
              [ { type => "word_0", modifier => "*0.001", unit => "V" } ]
        },
        "Absolute Load Value" => {
            command => "01 43",
            result =>
              [ { type => "word_0", modifier => "*100/255", unit => "%" } ]
        },
        "Commanded Equivalence Ratio" => {
            command => "01 44",
            result =>
              [ { type => "word_0", modifier => "*0.0000305", unit => "" } ]
        },
        ...
        "Minutes run by the engine while MIL activated" => {
            command => "01 4D",
            result  => [ { type => "word_0", modifier => "+0", unit => "min" } ]
        },
...
"Maximum value for Air Flow Rate from Mass Air Flow Sensor",
            ...
            result  => [
                {
                    ...
                    alternatives => [
                        ...
                        {
                            value   => 5,
                            meaning => "Liquefied Petroleum Gas (LPG)"
                        },
                        {
                            value   => 6,
                            meaning => "Compressed Natural Gas (CNG)"
                        },
                        { value => 7, meaning => "Propane" },
                        { value => 8, meaning => "Battery/electric" },
                        {
                            value   => 9,
                            meaning => "Bi-fuel vehicle using gasoline"
                        },
                        {
                            value   => 10,
                            meaning => "Bi-fuel vehicle using methanol"
                        },
                        {
                            value   => 11,
                            meaning => "Bi-fuel vehicle using ethanol"
                        },
                        { value => 12, meaning => "Bi-fuel vehicle using LPG" },
                        { value => 13, meaning => "Bi-fuel vehicle using CNG" },
                        {
                            value   => 14,
                            meaning => "Bi-fuel vehicle using propane"
                        },
                        {
                            value   => 15,
                            meaning => "Bi-fuel vehicle using battery"
                        }
                    ]
                }
            ]
        ...
        "Absolute Evap System Vapour Pressure" => {
            command => "01 53",
            result =>
              [ { type => "word_0", modifier => "/200", unit => "kPa" } ]
        },
        "Evap System Vapour Pressure" => {
            command => "01 54",
            result =>
              [ { type => "signed_word_0", modifier => "+1", unit => "Pa" } ]
        },
        "Short Term Secondary O2 Sensor Fuel Trim - Bank 1" => {
            command => "01 55",
            result  => [
                {
                    type     => "signed_byte_0",
        ...
        "Short Term Secondary O2 Sensor Fuel Trim - Bank 2" => {
            command => "01 57",
            result  => [
                {
                    type     => "signed_byte_0",
        ...
        "Long Term Secondary O2 Sensor Fuel Trim - Bank 2" => {
            command => "01 58",
            result  => [
                {
                    type     => "signed_byte_0",
        ...
        "Short Term Secondary O2 Sensor Fuel Trim - Bank 3" => {
            command => "01 55",
            result  => [
                {
                    type     => "signed_byte_1",
        ...
        "Long Term Secondary O2 Sensor Fuel Trim - Bank 3" => {
            command => "01 56",
            result  => [
                {
                    type     => "signed_byte_1",
        ...
        "Short Term Secondary O2 Sensor Fuel Trim - Bank 4" => {
            command => "01 57",
            result  => [
                {
                    type     => "signed_byte_1",
        ...
        "Long Term Secondary O2 Sensor Fuel Trim - Bank 4" => {
            command => "01 58",
            result  => [
                {
                    type     => "signed_byte_1",
        ...
        "02 PIDs supported (01-20)" => {
            ...
            result    => [
                {
                    name => "Freeze frame Monitor status since DTCs cleared",
                    type => "bool_0",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                ...
                {
                    name     => "Freeze frame Fuel systems status",
                    type     => "bool_0",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Calculated LOAD Value!",
                    type     => "bool_0",
                    modifier => "&16",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Engine Coolant Temperature",
                    type     => "bool_0",
                    modifier => "&8",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Short Term Fuel Trim - Bank 1/3",
                    type     => "bool_0",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Long Term Fuel Trim - Bank 1/3",
                    type     => "bool_0",
                    modifier => "&2",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Short Term Fuel Trim - Bank 2/4",
                    type     => "bool_0",
                    modifier => "&1",
                    unit     => "not supported,supported"
                },
                ...
                {
                    name     => "Freeze frame Long Term Fuel Trim - Bank 2/4",
                    type     => "bool_1",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Fuel Rail Pressure (gauge)",
                    type     => "bool_1",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
                {
                    name => "Freeze frame Intake Manifold Absolute Pressure",
                    type => "bool_1",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Engine RPM",
                    type     => "bool_1",
                    modifier => "&16",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Vehicle Speed Sensor",
                    type     => "bool_1",
                    modifier => "&8",
                    unit     => "not supported,supported"
                },
                {
                    name =>
                      "Freeze frame Ignition Timing Advance for #1 Cylinder",
                    type     => "bool_1",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Intake Air Temperature",
                    type     => "bool_1",
                    modifier => "&2",
                    unit     => "not supported,supported"
                },
                {
                    name =>
                      "Freeze frame Air Flow Rate from Mass Air Flow Sensor",
                    type     => "bool_1",
                    modifier => "&1",
                    unit     => "not supported,supported"
                },
                ...
                {
                    name     => "Freeze frame Absolute Throttle Position",
                    type     => "bool_2",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Commanded Secondary Air Status",
                    type     => "bool_2",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Location of oxygen sensors 13",
                    type     => "bool_2",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Bank 1 - Sensor 1",
                    type     => "bool_2",
                    modifier => "&16",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Bank 1 - Sensor 2",
                    type     => "bool_2",
                    modifier => "&8",
                    unit     => "not supported,supported"
                },
                ...
                {
                    name     => "Freeze frame Bank 1 - Sensor 3",
                    type     => "bool_2",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Bank 1 - Sensor 4",
                    type     => "bool_2",
                    modifier => "&2",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Bank 2 - Sensor 1 13",
                    type     => "bool_2",
                    modifier => "&1",
                    unit     => "not supported,supported"
                },
                ...
                {
                    name     => "Freeze frame Bank 2 - Sensor 2 13",
                    type     => "bool_3",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Bank 2 - Sensor 3",
                    type     => "bool_3",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Bank 2 - Sensor 4",
                    type     => "bool_3",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Bank 3 - Sensor 2",
                    type     => "bool_3",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Bank 4 - Sensor 1",
                    type     => "bool_3",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Bank 4 - Sensor 2",
                    type     => "bool_3",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                {
                    name =>
"Freeze frame OBD requirements to which vehicle is designed",
                    type     => "bool_3",
                    modifier => "&16",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Location of oxygen sensors 1D",
                    type     => "bool_3",
                    modifier => "&8",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Bank 2 - Sensor 1 1D",
                    type     => "bool_2",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Bank 2 - Sensor 2 1D",
                    type     => "bool_2",
                    modifier => "&2",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Bank 3 - Sensor 1",
                    type     => "bool_2",
                    modifier => "&1",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Auxiliary Input Status",
                    type     => "bool_3",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Time Since Engine Start",
                    type     => "bool_3",
                    modifier => "&2",
                    unit     => "not supported,supported"
                },
                {
                    name     => "02 PIDs supported (21-40)",
                    type     => "bool_3",
                    modifier => "&1",
                    unit     => "not supported,supported"
                },
        ...
        "Freeze frame Monitor status since DTCs cleared" => {
            command => "02 01",
            result  => [
                {
                    name => "Freeze frame Number of DTCs stored in this ECU",
                    type => "byte_0",
                    modifier => "&127",
                    unit     => ""
                },
                {
                    name =>
                      "Freeze frame Malfunction Indicator Lamp (MIL) Status",
                    type     => "bool_0",
                    modifier => "&128",
                    unit     => "off,on"
                },
                {
                    name     => "Freeze frame Misfire monitoring supported",
                    type     => "bool_1",
                    modifier => "&1",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Fuel system monitoring supported",
                    type     => "bool_1",
                    modifier => "&2",
                    unit     => "not supported,supported"
                },
                {
                    name =>
"Freeze frame Comprehensive component monitoring supported",
                    type     => "bool_1",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Misfire monitoring complete",
                    type     => "bool_1",
                    modifier => "&16",
                    unit     => "not completed, completed"
                },
                {
                    name     => "Freeze frame Fuel system monitoring complete",
                    type     => "bool_1",
                    modifier => "&32",
                    unit     => "not completed, completed"
                },
                {
                    name =>
"Freeze frame Comprehensive component monitoring complete",
                    type     => "bool_1",
                    modifier => "&64",
                    unit     => "not completed, completed"
                },
                {
                    name     => "Freeze frame Catalyst monitoring supported",
                    type     => "bool_2",
                    modifier => "&1",
                    unit     => "not supported,supported"
                },
                {
                    name => "Freeze frame Heated catalyst monitoring supported",
                    type => "bool_2",
                    modifier => "&2",
                    unit     => "not supported,supported"
                },
                {
                    name =>
                      "Freeze frame Evaporative system monitoring supported",
                    type     => "bool_2",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                {
                    name =>
                      "Freeze frame Secondary air system monitoring supported",
                    type     => "bool_2",
                    modifier => "&8",
                    unit     => "not supported,supported"
                },
                {
                    name =>
"Freeze frame A/C system refrigerant monitoring supported",
                    type     => "bool_2",
                    modifier => "&16",
                    unit     => "not supported,supported"
                },
                {
                    name => "Freeze frame Oxygen sensor monitoring supported",
                    type => "bool_2",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                {
                    name =>
                      "Freeze frame Oxygen sensor heater monitoring supported",
                    type     => "bool_2",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame EGR system monitoring supported",
                    type     => "bool_2",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Catalyst monitoring complete",
                    type     => "bool_3",
                    modifier => "&1",
                    unit     => "not completed, completed"
                },
                {
                    name => "Freeze frame Heated catalyst monitoring complete",
                    type => "bool_3",
                    modifier => "&2",
                    unit     => "not completed, completed"
                },
                {
                    name =>
                      "Freeze frame Evaporative system monitoring complete",
                    type     => "bool_3",
                    modifier => "&4",
                    unit     => "not completed, completed"
                },
                {
                    name =>
                      "Freeze frame Secondary air system monitoring complete",
                    type     => "bool_3",
                    modifier => "&8",
                    unit     => "not completed, completed"
                },
                {
                    name =>
                      "Freeze frame A/C system refrigerant monitoring complete",
                    type     => "bool_3",
                    modifier => "&16",
                    unit     => "not completed, completed"
                },
                {
                    name => "Freeze frame Oxygen sensor monitoring complete",
                    type => "bool_3",
                    modifier => "&32",
                    unit     => "not completed, completed"
                },
                {
                    name =>
                      "Freeze frame Oxygen sensor heater monitoring complete",
                    type     => "bool_3",
                    modifier => "&64",
                    unit     => "not completed, completed"
                },
                {
                    name     => "Freeze frame EGR system monitoring complete",
                    type     => "bool_3",
                    modifier => "&128",
                    unit     => "not completed, completed"
                },
        ...
        "DTC that caused required freeze frame data storage" => {
            command => "02 02",
            result  => [ { type => "word_0", modifier => "+0", unit => "" } ]
        },

        "Freeze frame Fuel systems status" => {
            command => "02 03",
            result  => [
                {
                    name         => "Freeze frame Fuel system 1 status",
                    type         => "byte_0",
                    modifier     => "&31",
                    unit         => "",
                    alternatives => [
...
"Closed loop, but fault with at least one oxygen sensor - may be using single oxygen sensor for fuel control"
                ...
                {
                    name         => "Freeze frame Fuel system 2 status",
                    type         => "byte_1",
                    modifier     => "&31",
                    unit         => "",
                    alternatives => [
...
"Closed loop, but fault with at least one oxygen sensor - may be using single oxygen sensor for fuel control"
        ...
        "Freeze frame Calculated LOAD Value!" => {
            command => "02 04",
            result =>
              [ { type => "byte_0", modifier => "*100/255", unit => "%" } ]
        },
        "Freeze frame Engine Coolant Temperature" => {
            command => "02 05",
            result => [ { type => "byte_0", modifier => "-40", unit => "°C" } ]
        },

        "Freeze frame Short Term Fuel Trim - Bank 1/3" => {
            command => "02 06",
            result  => [
                {
                    name     => "Freeze frame Short Term Fuel Trim - Bank 1",
                    type     => "signed_byte_0",
                    modifier => "*100/128",
                    unit     => "%"
                },
                {
                    name     => "Freeze frame Short Term Fuel Trim - Bank 3",
                    type     => "signed_byte_1",
                    modifier => "*100/128",
                    unit     => "%"
                },
        ...
        "Freeze frame Long Term Fuel Trim - Bank 1/3" => {
            command => "02 07",
            result  => [
                {
                    name     => "Freeze frame Long Term Fuel Trim - Bank 1",
                    type     => "signed_byte_0",
                    modifier => "*100/128",
                    unit     => "%"
                },
                {
                    name     => "Freeze frame Long Term Fuel Trim - Bank 3",
                    type     => "signed_byte_1",
                    modifier => "*100/128",
                    unit     => "%"
                },
        ...
        "Freeze frame Short Term Fuel Trim - Bank 2/4" => {
            command => "02 08",
            result  => [
                {
                    name     => "Freeze frame Short Term Fuel Trim - Bank 2",
                    type     => "signed_byte_0",
                    modifier => "*100/128",
                    unit     => "%"
                },
                {
                    name     => "Freeze frame Short Term Fuel Trim - Bank 4",
                    type     => "signed_byte_1",
                    modifier => "*100/128",
                    unit     => "%"
                },
        ...
        "Freeze frame Long Term Fuel Trim - Bank 2/4" => {
            command => "02 09",
            result  => [
                {
                    name     => "Freeze frame Long Term Fuel Trim - Bank 2",
                    type     => "signed_byte_0",
                    modifier => "*100/128",
                    unit     => "%"
                },
                {
                    name     => "Freeze frame Long Term Fuel Trim - Bank 4",
                    type     => "signed_byte_1",
                    modifier => "*100/128",
                    unit     => "%"
                },
        ...
        "Freeze frame Fuel Rail Pressure (gauge)" => {
            command => "02 0A",
            result  => [ { type => "byte_0", modifier => "*3", unit => "kPa" } ]
        },
        "Freeze frame Intake Manifold Absolute Pressure" => {
            command => "02 0B",
            result  => [ { type => "byte_0", modifier => "*1", unit => "kPa" } ]
        },
        ...
        "Freeze frame Vehicle Speed Sensor" => {
            command => "02 0D",
            result => [ { type => "byte_0", modifier => "+0", unit => "km/h" } ]
        },
        "Freeze frame Ignition Timing Advance for #1 Cylinder" => {
        ...
        "Freeze frame Intake Air Temperature" => {
            command => "02 0F",
            result => [ { type => "byte_0", modifier => "-40", unit => "°C" } ]
        },
        "Freeze frame Air Flow Rate from Mass Air Flow Sensor" => {
        ...
        "Freeze frame Absolute Throttle Position" => {
            command => "02 11",
            result =>
              [ { type => "byte_0", modifier => "*100/255", unit => "%" } ]
        },
        "Freeze frame Commanded Secondary Air Status" => {
            command => "02 12",
            result  => [
                {
                    type         => "byte_0",
        ...
        "Freeze frame Location of oxygen sensors 13" => {
            command => "02 13",
            result  => [
                {
                    name     => "Freeze frame Bank 1 - Sensor 1 present",
                    type     => "bool_0",
                    modifier => "&1",
                    unit     => "not present,present"
                },
                {
                    name     => "Freeze frame Bank 1 - Sensor 2 present",
                    type     => "bool_0",
                    modifier => "&2",
                    unit     => "not present,present"
                },
                {
                    name     => "Freeze frame Bank 1 - Sensor 3 present",
                    type     => "bool_0",
                    modifier => "&4",
                    unit     => "not present,present"
                },
                {
                    name     => "Freeze frame Bank 1 - Sensor 4 present",
                    type     => "bool_0",
                    modifier => "&8",
                    unit     => "not present,present"
                },
                {
                    name     => "Freeze frame Bank 2 - Sensor 1 present",
                    type     => "bool_0",
                    modifier => "&16",
                    unit     => "not present,present"
                },
                {
                    name     => "Freeze frame Bank 2 - Sensor 2 present",
                    type     => "bool_0",
                    modifier => "&32",
                    unit     => "not present,present"
                },
                {
                    name     => "Freeze frame Bank 2 - Sensor 3 present",
                    type     => "bool_0",
                    modifier => "&64",
                    unit     => "not present,present"
                },
                {
                    name     => "Freeze frame Bank 2 - Sensor 4 present",
                    type     => "bool_0",
                    modifier => "&128",
                    unit     => "not present,present"
                }
        ...
        "Freeze frame Bank 1 - Sensor 1" => {
            command => "02 14",
            result  => [
                {
                    name => "Freeze frame Oxygen Sensor Output Voltage (Bx-Sy)",
                    type => "byte_0",
                    modifier => "*0.005",
                    unit     => "V"
                },
                {
                    name     => "Freeze frame Short Term Fuel Trim (Bx-Sy)",
                    type     => "byte_1",
                    modifier => "*100/255",
                    unit     => "%"
                }
        ...
        "Freeze frame Bank 2 - Sensor 1 13" => {
            command => "02 18",
            result  => [
                {
                    name => "Freeze frame Oxygen Sensor Output Voltage (Bx-Sy)",
        ...
        "Freeze frame Bank 2 - Sensor 2 13" => {
            command => "02 19",
            result  => [
                {
                    name => "Freeze frame Oxygen Sensor Output Voltage (Bx-Sy)",
        ...
        "Freeze frame Bank 2 - Sensor 1 1D" => {
            command => "02 16",
            result  => [
                {
                    name => "Freeze frame Oxygen Sensor Output Voltage (Bx-Sy)",
        ...
        "Freeze frame Bank 2 - Sensor 2 1D" => {
            command => "02 17",
            result  => [
                {
                    name => "Freeze frame Oxygen Sensor Output Voltage (Bx-Sy)",
        ...
        "Freeze frame Location of oxygen sensors 1D" => {
            command => "02 1D",
            result  => [
                {
                    name     => "Freeze frame Bank 1 - Sensor 1 present",
                ...
                {
                    name     => "Freeze frame Bank 3 - Sensor 1 present",
                    type     => "bool_0",
                    modifier => "&16",
                    unit     => "not present,present"
                },
                {
                    name     => "Freeze frame Bank 3 - Sensor 2 present",
                    type     => "bool_0",
                    modifier => "&32",
                    unit     => "not present,present"
                },
                {
                    name     => "Freeze frame Bank 4 - Sensor 1 present",
                    type     => "bool_0",
                    modifier => "&64",
                    unit     => "not present,present"
                },
                {
                    name     => "Freeze frame Bank 4 - Sensor 2 present",
                    type     => "bool_0",
                    modifier => "&128",
                    unit     => "not present,present"
                },
        ...
        "Freeze frame Auxiliary Input Status" => {
            command => "02 1E",
            result  => [
                {
                    name     => "Freeze frame Power Take Off (PTO) Status",
                    type     => "bool_0",
                    modifier => "&1",
                    unit     => "off,on"
                }
        ...
        "Freeze frame Time Since Engine Start" => {
            command => "02 1F",
            result  => [ { type => "word_0", modifier => "*10", unit => "s" } ]
        },

        "02 PIDs supported (21-40)" => {
            command => "02 20",
            result  => [
                {
                    name =>
                      "Freeze frame Distance Travelled While MIL is Activated",
                    type     => "bool_0",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                {
                    name =>
"Freeze frame Fuel Rail Pressure relative to manifold vacuum",
                    type     => "bool_0",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Fuel Rail Pressure",
                    type     => "bool_0",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                {
                    name => "Freeze frame Bank 1 - Sensor 1 (wide range O2S)",
                    type => "bool_0",
                    modifier => "&16",
                    unit     => "not supported,supported"
                },
                {
                    name => "Freeze frame Bank 1 - Sensor 2 (wide range O2S)",
                    type => "bool_0",
                    modifier => "&8",
                    unit     => "not supported,supported"
                },
                ...
                {
                    name => "Freeze frame Bank 1 - Sensor 3 (wide range O2S)",
                    type => "bool_0",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                {
                    name => "Freeze frame Bank 1 - Sensor 4 (wide range O2S)",
                    type => "bool_0",
                    modifier => "&2",
                    unit     => "not supported,supported"
                },
                {
                    name =>
                      "Freeze frame Bank 2 - Sensor 1 (wide range O2S) 13",
                    type     => "bool_0",
                    modifier => "&1",
                    unit     => "not supported,supported"
                },
                {
                    name =>
                      "Freeze frame Bank 2 - Sensor 1 (wide range O2S) 1D",
                    type     => "bool_0",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                {
                    name =>
                      "Freeze frame Bank 2 - Sensor 2 (wide range O2S) 1D",
                    type     => "bool_0",
                    modifier => "&2",
                    unit     => "not supported,supported"
                },
                {
                    name => "Freeze frame Bank 3 - Sensor 1 (wide range O2S)",
                    type => "bool_0",
                    modifier => "&1",
                    unit     => "not supported,supported"
                },
                ...
                {
                    name =>
                      "Freeze frame Bank 2 - Sensor 2 (wide range O2S) 13",
                    type     => "bool_1",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                {
                    name => "Freeze frame Bank 2 - Sensor 3 (wide range O2S)",
                    type => "bool_1",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
                {
                    name => "Freeze frame Bank 2 - Sensor 4 (wide range O2S)",
                    type => "bool_1",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                {
                    name => "Freeze frame Bank 3 - Sensor 2 (wide range O2S)",
                    type => "bool_1",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                {
                    name => "Freeze frame Bank 4 - Sensor 1 (wide range O2S)",
                    type => "bool_1",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
                {
                    name => "Freeze frame Bank 4 - Sensor 2 (wide range O2S)",
                    type => "bool_1",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                ...
                {
                    name     => "Freeze frame Commanded EGR",
                    type     => "bool_1",
                    modifier => "&16",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame EGR Error",
                    type     => "bool_1",
                    modifier => "&8",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Commanded Evaporative Purge",
                    type     => "bool_1",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Fuel Level Input",
                    type     => "bool_1",
                    modifier => "&2",
                    unit     => "not supported,supported"
                },
                {
                    name =>
"Freeze frame Number of warm-ups since diagnostic trouble codes cleared",
                    type     => "bool_1",
                    modifier => "&1",
                    unit     => "not supported,supported"
                },
                ...
                {
                    name =>
"Freeze frame Distance since diagnostic trouble codes cleared",
                    type     => "bool_2",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Evap System Vapor Pressure",
                    type     => "bool_2",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Barometric Pressure",
                    type     => "bool_2",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                {
                    name =>
                      "Freeze frame Bank 1 - Sensor 1 (wide range O2S) current",
                    type     => "bool_2",
                    modifier => "&16",
                    unit     => "not supported,supported"
                },
                {
                    name =>
                      "Freeze frame Bank 1 - Sensor 2 (wide range O2S) current",
                    type     => "bool_2",
                    modifier => "&8",
                    unit     => "not supported,supported"
                },
                {
                    name =>
                      "Freeze frame Bank 1 - Sensor 3 (wide range O2S) current",
                    type     => "bool_2",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                {
                    name =>
                      "Freeze frame Bank 1 - Sensor 4 (wide range O2S) current",
                    type     => "bool_2",
                    modifier => "&2",
                    unit     => "not supported,supported"
                },
                {
                    name =>
"Freeze frame Bank 2 - Sensor 1 (wide range O2S) current 13",
                    type     => "bool_2",
                    modifier => "&1",
                    unit     => "not supported,supported"
                },
                ...
                {
                    name =>
"Freeze frame Bank 2 - Sensor 1 (wide range O2S) current 1D",
                    type     => "bool_2",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                {
                    name =>
"Freeze frame Bank 2 - Sensor 2 (wide range O2S) current 1D",
                    type     => "bool_2",
                    modifier => "&2",
                    unit     => "not supported,supported"
                },
                {
                    name =>
                      "Freeze frame Bank 3 - Sensor 1 (wide range O2S) current",
                    type     => "bool_2",
                    modifier => "&1",
                    unit     => "not supported,supported"
                },
                ...
                {
                    name =>
"Freeze frame Bank 2 - Sensor 2 (wide range O2S) current 13",
                    type     => "bool_3",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                {
                    name =>
                      "Freeze frame Bank 2 - Sensor 3 (wide range O2S) current",
                    type     => "bool_3",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
                {
                    name =>
                      "Freeze frame Bank 2 - Sensor 4 (wide range O2S) current",
                    type     => "bool_3",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                {
                    name =>
                      "Freeze frame Bank 3 - Sensor 2 (wide range O2S) current",
                    type     => "bool_3",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                {
                    name =>
                      "Freeze frame Bank 4 - Sensor 1 (wide range O2S) current",
                    type     => "bool_3",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
                {
                    name =>
                      "Freeze frame Bank 4 - Sensor 2 (wide range O2S) current",
                    type     => "bool_3",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                {
                    name =>
                      "Freeze frame Catalyst Temperature Bank 1, Sensor 1",
                    type     => "bool_3",
                    modifier => "&16",
                    unit     => "not supported,supported"
                },
                {
                    name =>
                      "Freeze frame Catalyst Temperature Bank 1, Sensor 2",
                    type     => "bool_3",
                    modifier => "&8",
                    unit     => "not supported,supported"
                },
                {
                    name =>
                      "Freeze frame Catalyst Temperature Bank 2, Sensor 1",
                    type     => "bool_3",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                {
                    name =>
                      "Freeze frame Catalyst Temperature Bank 2, Sensor 2",
                    type     => "bool_3",
                    modifier => "&2",
                    unit     => "not supported,supported"
                },
                {
                    name     => "02 PIDs supported (41-60)",
                    type     => "bool_3",
                    modifier => "&1",
                    unit     => "not supported,supported"
                },
        ...
        "Freeze frame Fuel Rail Pressure" => {
            command => "02 23",
            result => [ { type => "word_0", modifier => "*10", unit => "kPa" } ]
        },

        "Freeze frame Bank 1 - Sensor 1 (wide range O2S)" => {
            command => "02 24",
            result  => [
                {
                    name => "Freeze frame Equivalence Ratio (lambda) (Bx-Sy)",
                    type => "word_0",
                    modifier => "*0.0000305",
                    unit     => ""
                },
                {
                    name     => "Freeze frame Oxygen Sensor Voltage (Bx-Sy)",
                    type     => "word_1",
                    modifier => "*0.000122",
                    unit     => "V"
                }
        ...
        "Freeze frame Bank 1 - Sensor 2 (wide range O2S)" => {
            command => "02 25",
            result  => [
                {
                    name => "Freeze frame Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Freeze frame Bank 1 - Sensor 3 (wide range O2S)" => {
            command => "02 26",
            result  => [
                {
                    name => "Freeze frame Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Freeze frame Bank 1 - Sensor 4 (wide range O2S)" => {
            command => "02 27",
            result  => [
                {
                    name => "Freeze frame Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Freeze frame Bank 2 - Sensor 3 (wide range O2S)" => {
            command => "02 2A",
            result  => [
                {
                    name => "Freeze frame Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Freeze frame Bank 2 - Sensor 4 (wide range O2S)" => {
            command => "02 2B",
            result  => [
                {
                    name => "Freeze frame Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Freeze frame Bank 3 - Sensor 1 (wide range O2S)" => {
            command => "02 28",
            result  => [
                {
                    name => "Freeze frame Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Freeze frame Bank 3 - Sensor 2 (wide range O2S)" => {
            command => "02 29",
            result  => [
                {
                    name => "Freeze frame Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Freeze frame Bank 4 - Sensor 1 (wide range O2S)" => {
            command => "02 2A",
            result  => [
                {
                    name => "Freeze frame Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Freeze frame Bank 4 - Sensor 2 (wide range O2S)" => {
            command => "02 2B",
            result  => [
                {
                    name => "Freeze frame Equivalence Ratio (lambda) (Bx-Sy)",
        ...
        "Freeze frame Commanded EGR" => {
            command => "02 2C",
            result =>
              [ { type => "byte_0", modifier => "*100/255", unit => "%" } ]
        },
        "Freeze frame EGR Error" => {
            command => "02 2D",
            result  => [
                {
                    type     => "signed_byte_0",
        ...
        "Freeze frame Commanded Evaporative Purge" => {
            command => "02 2E",
            result =>
              [ { type => "byte_0", modifier => "*100/255", unit => "%" } ]
        },
        "Freeze frame Fuel Level Input" => {
            command => "02 2F",
            result =>
              [ { type => "byte_0", modifier => "*100/255", unit => "%" } ]
        },
        ...
        "Freeze frame Evap System Vapor Pressure" => {
            command => "02 32",
            result  => [
                { type => "signed_word_0", modifier => "*0.25", unit => "Pa" }
            ]
        },
        "Freeze frame Barometric Pressure" => {
            command => "02 33",
            result  => [ { type => "byte_0", modifier => "+0", unit => "kPa" } ]
        },
        ...
        "Freeze frame Bank 1 - Sensor 1 (wide range O2S) current" => {
            ...
            result  => [
                ...
                {
                    name     => "Freeze frame Oxygen Sensor Current (Bx-Sy)",
                    type     => "signed_word_1",
                    modifier => "*0.000122",
                    unit     => "A"
                }
        ...
        "02 PIDs supported (41-60)" => {
            command => "02 40",
            result  => [
                {
                    name => "Freeze frame Monitor status this driving cycle",
                    type => "bool_0",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Control Module Voltage",
                    type     => "bool_0",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Absolute Load Value",
                    type     => "bool_0",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Commanded Equivalence Ratio",
                    type     => "bool_0",
                    modifier => "&16",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Relative Throttle Position",
                    type     => "bool_0",
                    modifier => "&8",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Ambiant Air Temperature",
                    type     => "bool_0",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Absolute Throttle Position B",
                    type     => "bool_0",
                    modifier => "&2",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Absolute Throttle Position C",
                    type     => "bool_0",
                    modifier => "&1",
                    unit     => "not supported,supported"
                },
                ...
                {
                    name     => "Freeze frame Absolute Throttle Position D",
                    type     => "bool_1",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Absolute Throttle Position E",
                    type     => "bool_1",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Absolute Throttle Position F",
                    type     => "bool_1",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                {
                    name => "Freeze frame Commanded Throttle Actuator Control",
                    type => "bool_1",
                    modifier => "&16",
                    unit     => "not supported,supported"
                },
                {
                    name =>
"Freeze frame Minutes run by the engine while MIL activated",
                    type     => "bool_1",
                    modifier => "&8",
                    unit     => "not supported,supported"
                },
                {
                    name =>
"Freeze frame Time since diagnostic trouble codes cleared",
                    type     => "bool_1",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                {
                    name =>
"Freeze frame External Test Equipment Configuration Information #1",
                    type     => "bool_1",
                    modifier => "&2",
                    unit     => "not supported,supported"
                },
                {
                    name =>
"Freeze frame External Test Equipment Configuration Information #2",
                    type     => "bool_1",
                    modifier => "&1",
                    unit     => "not supported,supported"
                },
                ...
                {
                    name =>
"Freeze frame Type of fuel currently being utilized by the vehicle",
                    type     => "bool_2",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Alcohol Fuel Percentage",
                    type     => "bool_2",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
                {
                    name => "Freeze frame Absolute Evap System Vapour Pressure",
                    type => "bool_2",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Freeze frame Evap System Vapour Pressure",
                    type     => "bool_2",
                    modifier => "&16",
                    unit     => "not supported,supported"
                },
                {
                    name =>
"Freeze frame Short Term Secondary O2 Sensor Fuel Trim - Bank 1",
                    type     => "bool_2",
                    modifier => "&8",
                    unit     => "not supported,supported"
                },
                {
                    name =>
"Freeze frame Long Term Secondary O2 Sensor Fuel Trim - Bank 1",
                    type     => "bool_2",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                {
                    name =>
"Freeze frame Short Term Secondary O2 Sensor Fuel Trim - Bank 2",
                    type     => "bool_2",
                    modifier => "&2",
                    unit     => "not supported,supported"
                },
                {
                    name =>
"Freeze frame Long Term Secondary O2 Sensor Fuel Trim - Bank 2",
                    type     => "bool_2",
                    modifier => "&1",
                    unit     => "not supported,supported"
                },
                {
                    name =>
"Freeze frame Short Term Secondary O2 Sensor Fuel Trim - Bank 3",
                    type     => "bool_2",
                    modifier => "&8",
                    unit     => "not supported,supported"
                },
                {
                    name =>
"Freeze frame Long Term Secondary O2 Sensor Fuel Trim - Bank 3",
                    type     => "bool_2",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                {
                    name =>
"Freeze frame Short Term Secondary O2 Sensor Fuel Trim - Bank 4",
                    type     => "bool_2",
                    modifier => "&2",
                    unit     => "not supported,supported"
                },
                {
                    name =>
"Freeze frame Long Term Secondary O2 Sensor Fuel Trim - Bank 4",
                    type     => "bool_2",
                    modifier => "&1",
                    unit     => "not supported,supported"
                },
                ...
                {
                    name     => "Freeze frame Fuel Rail Pressure (absolute)",
                    type     => "bool_3",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                {
                    name => "Freeze frame Relative Accelerator Pedal Position",
                    type => "bool_3",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
...
#            {name => "02 PIDs supported (61-80)", type => "bool_3", modifier => "&1", unit => "not supported,supported"},
        ...
        "Freeze frame Monitor status this driving cycle" => {
            command => "02 41",
            result  => [
                {
                    name     => "Freeze frame Misfire monitoring Enable Status",
                    type     => "bool_1",
                    modifier => "&1",
                    unit     => "not enabled,enabled"
                },
                {
                    name => "Freeze frame Fuel system monitoring Enable Status",
                    type => "bool_1",
                    modifier => "&2",
                    unit     => "not enabled,enabled"
                },
                {
                    name =>
"Freeze frame Comprehensive component monitoring Enable Status",
                    type     => "bool_1",
                    modifier => "&4",
                    unit     => "not enabled,enabled"
                },
                {
                    name => "Freeze frame Misfire monitoring Completion Status",
                    type => "bool_1",
                    modifier => "&16",
                    unit     => "not completed,completed"
                },
                {
                    name =>
                      "Freeze frame Fuel system monitoring Completion Status",
                    type     => "bool_1",
                    modifier => "&32",
                    unit     => "not completed,completed"
                },
                {
                    name =>
"Freeze frame Comprehensive component monitoring Completion Status",
                    type     => "bool_1",
                    modifier => "&64",
                    unit     => "not completed,completed"
                },
                {
                    name => "Freeze frame Catalyst monitoring Enable Status",
                    type => "bool_2",
                    modifier => "&1",
                    unit     => "not enabled,enabled"
                },
                {
                    name =>
                      "Freeze frame Heated catalyst monitoring Enable Status",
                    type     => "bool_2",
                    modifier => "&2",
                    unit     => "not enabled,enabled"
                },
                {
                    name =>
"Freeze frame Evaporative system monitoring Enable Status",
                    type     => "bool_2",
                    modifier => "&4",
                    unit     => "not enabled,enabled"
                },
                {
                    name =>
"Freeze frame Secondary air system monitoring Enable Status",
                    type     => "bool_2",
                    modifier => "&8",
                    unit     => "not enabled,enabled"
                },
                {
                    name =>
"Freeze frame A/C system refrigerant monitoring Enable Status",
                    type     => "bool_2",
                    modifier => "&16",
                    unit     => "not enabled,enabled"
                },
                {
                    name =>
                      "Freeze frame Oxygen sensor monitoring Enable Status",
                    type     => "bool_2",
                    modifier => "&32",
                    unit     => "not enabled,enabled"
                },
                {
                    name =>
"Freeze frame Oxygen sensor heater monitoring Enable Status",
                    type     => "bool_2",
                    modifier => "&64",
                    unit     => "not enabled,enabled"
                },
                {
                    name     => "Freeze frame EGR monitoring Enable Status",
                    type     => "bool_2",
                    modifier => "&128",
                    unit     => "not enabled,enabled"
                },
                {
                    name =>
                      "Freeze frame Catalyst monitoring Completion Status",
                    type     => "bool_3",
                    modifier => "&1",
                    unit     => "not completed,completed"
                },
                {
                    name =>
"Freeze frame Heated catalyst monitoring Completion Status",
                    type     => "bool_3",
                    modifier => "&2",
                    unit     => "not completed,completed"
                },
                {
                    name =>
"Freeze frame Evaporative system monitoring Completion Status",
                    type     => "bool_3",
                    modifier => "&4",
                    unit     => "not completed,completed"
                },
                {
                    name =>
"Freeze frame Secondary air system monitoring Completion Status",
                    type     => "bool_3",
                    modifier => "&8",
                    unit     => "not completed,completed"
                },
                {
                    name =>
"Freeze frame A/C system refrigerant monitoring Completion Status",
                    type     => "bool_3",
                    modifier => "&16",
                    unit     => "not completed,completed"
                },
                {
                    name =>
                      "Freeze frame Oxygen sensor monitoring Completion Status",
                    type     => "bool_3",
                    modifier => "&32",
                    unit     => "not completed,completed"
                },
                {
                    name =>
"Freeze frame Oxygen sensor heater monitoring Completion Status",
                    type     => "bool_3",
                    modifier => "&64",
                    unit     => "not completed,completed"
                },
                {
                    name     => "Freeze frame EGR monitoring Completion Status",
                    type     => "bool_3",
                    modifier => "&128",
                    unit     => "not completed,completed"
                }
        ...
        "Freeze frame Control Module Voltage" => {
            command => "02 42",
            result =>
              [ { type => "word_0", modifier => "*0.001", unit => "V" } ]
        },
        "Freeze frame Absolute Load Value" => {
            command => "02 43",
            result =>
              [ { type => "word_0", modifier => "*100/255", unit => "%" } ]
        },
        "Freeze frame Commanded Equivalence Ratio" => {
            command => "02 44",
            result =>
              [ { type => "word_0", modifier => "*0.0000305", unit => "" } ]
        },
        "Freeze frame Relative Throttle Position" => {
            command => "02 45",
            result =>
              [ { type => "byte_0", modifier => "*100/255", unit => "%" } ]
        },
        "Freeze frame Ambiant Air Temperature" => {
            command => "02 46",
            result => [ { type => "byte_0", modifier => "-40", unit => "°C" } ]
        },
        "Freeze frame Absolute Throttle Position B" => {
            command => "02 47",
            result =>
              [ { type => "byte_0", modifier => "*100/255", unit => "%" } ]
        },
        "Freeze frame Absolute Throttle Position C" => {
            command => "02 48",
            result =>
              [ { type => "byte_0", modifier => "*100/255", unit => "%" } ]
        },
        "Freeze frame Accelerator Pedal Position D" => {
            command => "02 49",
            result =>
              [ { type => "byte_0", modifier => "*100/255", unit => "%" } ]
        },
        "Freeze frame Accelerator Pedal Position E" => {
            command => "02 4A",
            result =>
              [ { type => "byte_0", modifier => "*100/255", unit => "%" } ]
        },
        "Freeze frame Accelerator Pedal Position F" => {
            command => "02 4B",
            result =>
              [ { type => "byte_0", modifier => "*100/255", unit => "%" } ]
        },
        "Freeze frame Commanded Throttle Actuator Control" => {
            command => "02 4C",
            result =>
              [ { type => "byte_0", modifier => "*100/255", unit => "%" } ]
        },
        ...
        "Freeze frame External Test Equipment Configuration Information #1" => {
            ...
            result  => [
                {
                    name => "Freeze frame Maximum value for Equivalence Ratio",
                    type => "byte_0",
                    modifier => "+0",
                    unit     => ""
                },
                {
                    name =>
                      "Freeze frame Maximum value for Oxygen Sensor Voltage",
                    type     => "byte_1",
                    modifier => "+0",
                    unit     => "V"
                },
                {
                    name =>
                      "Freeze frame Maximum value for Oxygen Sensor Current",
                    type     => "byte_2",
                    modifier => "+0",
                    unit     => "mA"
                },
                {
                    name =>
"Freeze frame Maximum value for Intake Manifold Absolute Pressure",
                    type     => "byte_3",
                    modifier => "+0",
                    unit     => "kPa"
                },
        ...
        "Freeze frame External Test Equipment Configuration Information #2" => {
            ...
            result  => [
                {
                    name =>
"Freeze frame Maximum value for Air Flow Rate from Mass Air Flow Sensor",
                    type     => "byte_0",
                    modifier => "+0",
                    unit     => "g/s"
                }
        ...
        "Freeze frame Alcohol Fuel Percentage" => {
            command => "02 52",
            result =>
              [ { type => "byte_0", modifier => "*100/255", unit => "%" } ]
        },
        "Freeze frame Absolute Evap System Vapour Pressure" => {
            command => "02 53",
            result =>
              [ { type => "word_0", modifier => "/200", unit => "kPa" } ]
        },
        "Freeze frame Evap System Vapour Pressure" => {
            command => "02 54",
            result =>
              [ { type => "signed_word_0", modifier => "+1", unit => "Pa" } ]
        },
        ...
        "Freeze frame Fuel Rail Pressure (absolute)" => {
            command => "02 59",
            result => [ { type => "word_0", modifier => "*10", unit => "kPa" } ]
        },
        "Freeze frame Relative Accelerator Pedal Position" => {
            command => "02 5A",
            result =>
              [ { type => "byte_0", modifier => "*100/255", unit => "%" } ]
        },
        ...
        "05 TIDs supported (01-20)" => {
            command => "05 00",
            result  => [
                {
                    name     => "Rich to lean sensor threshold voltage",
                    type     => "bool_0",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Lean to rich sensor threshold voltage",
                    type     => "bool_0",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
                {
                    name => "Low sensor voltage for switch time calculation",
                    type => "bool_0",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                {
                    name => "High sensor voltage for switch time calculation",
                    type => "bool_0",
                    modifier => "&16",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Rich to lean sensor switch time",
                    type     => "bool_0",
                    modifier => "&8",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Lean to rich sensor switch time",
                    type     => "bool_0",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Minimum sensor voltage for test cycle",
                    type     => "bool_0",
                    modifier => "&2",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Maximum sensor voltage for test cycle",
                    type     => "bool_0",
                    modifier => "&1",
                    unit     => "not supported,supported"
                },
                ...
                {
                    name     => "Time between sensor transitions",
                    type     => "bool_1",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
...
#            {name => "05 TIDs supported (21-40)", type => "bool_3", modifier => "&1", unit => "not supported,supported"},
        ...
        "Rich to lean sensor switch time" => {
            ...
            result  => [
                ...
                {
                    name     => "Rich to lean sensor switch time - low limit",
                    type     => "byte_1",
                    modifier => "*0.004",
                    unit     => "s"
                },
                {
                    name     => "Rich to lean sensor switch time - high limit",
                    type     => "byte_2",
                    modifier => "*0.004",
                    unit     => "s"
                },
        ...
        "Lean to rich sensor switch time" => {
            ...
            result  => [
                { type => "byte_0", modifier => "*0.004", unit => "s" },
                {
                    name     => "Lean to rich sensor switch time - low limit",
                    type     => "byte_1",
                    modifier => "*0.004",
                    unit     => "s"
                },
                {
                    name     => "Lean to rich sensor switch time - high limit",
                    type     => "byte_2",
                    modifier => "*0.004",
                    unit     => "s"
                },
        ...
        "Minimum sensor voltage for test cycle" => {
            ...
            result  => [
                { type => "byte_0", modifier => "*0.005", unit => "V" },
                {
                    name => "Minimum sensor voltage for test cycle - low limit",
                    type => "byte_1",
                    modifier => "*0.005",
                    unit     => "V"
                },
                {
                    name =>
                      "Minimum sensor voltage for test cycle - high limit",
                    type     => "byte_2",
                    modifier => "*0.005",
                    unit     => "V"
                },
        ...
        "Maximum sensor voltage for test cycle" => {
            ...
            result  => [
                { type => "byte_0", modifier => "*0.005", unit => "V" },
                {
                    name => "Maximum sensor voltage for test cycle - low limit",
                    type => "byte_1",
                    modifier => "*0.005",
                    unit     => "V"
                },
                {
                    name =>
                      "Maximum sensor voltage for test cycle - high limit",
                    type     => "byte_2",
                    modifier => "*0.005",
                    unit     => "V"
                },
        ...
        "Time between sensor transitions" => {
            ...
            result  => [
                ...
                {
                    name     => "Time between sensor transitions - low limit",
                    type     => "byte_1",
                    modifier => "*0.04",
                    unit     => "s"
                },
                {
                    name     => "Time between sensor transitions - high limit",
                    type     => "byte_2",
                    modifier => "*0.04",
                    unit     => "s"
                },
        ...
        "Sensor period" => {
            ...
            result  => [
                { type => "byte_0", modifier => "*0.04", unit => "s" },
                {
                    name     => "Sensor period - low limit",
                    type     => "byte_1",
                    modifier => "*0.04",
                    unit     => "s"
                },
                {
                    name     => "Sensor period - high limit",
                    type     => "byte_2",
                    modifier => "*0.04",
                    unit     => "s"
                },
        ...
        "06 MIDs supported (01-20)" => {
            ...
            result  => [
                ...
                {
                    name     => "Oxygen Sensor Monitor Bank 1 - Sensor 3",
                    type     => "bool_0",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Oxygen Sensor Monitor Bank 1 - Sensor 4",
                    type     => "bool_0",
                    modifier => "&16",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Oxygen Sensor Monitor Bank 2 - Sensor 1",
                    type     => "bool_0",
                    modifier => "&8",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Oxygen Sensor Monitor Bank 2 - Sensor 2",
                    type     => "bool_0",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Oxygen Sensor Monitor Bank 2 - Sensor 3",
                    type     => "bool_0",
                    modifier => "&2",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Oxygen Sensor Monitor Bank 2 - Sensor 4",
                    type     => "bool_0",
                    modifier => "&1",
                    unit     => "not supported,supported"
                },
                ...
                {
                    name     => "Oxygen Sensor Monitor Bank 3 - Sensor 1",
                    type     => "bool_1",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Oxygen Sensor Monitor Bank 3 - Sensor 2",
                    type     => "bool_1",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Oxygen Sensor Monitor Bank 3 - Sensor 3",
                    type     => "bool_1",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Oxygen Sensor Monitor Bank 3 - Sensor 4",
                    type     => "bool_1",
                    modifier => "&16",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Oxygen Sensor Monitor Bank 4 - Sensor 1",
                    type     => "bool_1",
                    modifier => "&8",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Oxygen Sensor Monitor Bank 4 - Sensor 2",
                    type     => "bool_1",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Oxygen Sensor Monitor Bank 4 - Sensor 3",
                    type     => "bool_1",
                    modifier => "&2",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Oxygen Sensor Monitor Bank 4 - Sensor 4",
                    type     => "bool_1",
                    modifier => "&1",
                    unit     => "not supported,supported"
                },
...
#            {name => "", type => "bool_3", modifier => "&2", unit => "not supported,supported"},
        ...
        "Oxygen Sensor Monitor Bank 1 - Sensor 1" => {
            command => "06 01",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        ...
        "Oxygen Sensor Monitor Bank 3 - Sensor 1" => {
            command => "06 09",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        ...
        "06 MIDs supported (21-40)" => {
            ...
            result  => [
                ...
                {
                    name     => "Catalyst Monitor Bank 3",
                    type     => "bool_0",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Catalyst Monitor Bank 4",
                    type     => "bool_0",
                    modifier => "&16",
                    unit     => "not supported,supported"
                },
...
#            {name => "", type => "bool_1", modifier => "&1", unit => "not supported,supported"},
                ...
                {
                    name     => "EGR Monitor Bank 1",
                    type     => "bool_2",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                {
                    name     => "EGR Monitor Bank 2",
                    type     => "bool_2",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
                {
                    name     => "EGR Monitor Bank 3",
                    type     => "bool_2",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                {
                    name     => "EGR Monitor Bank 4",
                    type     => "bool_2",
                    modifier => "&16",
                    unit     => "not supported,supported"
                },
...
#            {name => "", type => "bool_2", modifier => "&1", unit => "not supported,supported"},
                ...
                {
                    name     => "EVAP Monitor (Cap Off)",
                    type     => "bool_3",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                {
                    name     => "EVAP Monitor (0,090)",
                    type     => "bool_3",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
                {
                    name     => "EVAP Monitor (0,040)",
                    type     => "bool_3",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                {
                    name     => "EVAP Monitor (0,020)",
                    type     => "bool_3",
                    modifier => "&16",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Purge Flow Monitor",
                    type     => "bool_3",
                    modifier => "&8",
                    unit     => "not supported,supported"
                },
...
#            {name => "", type => "bool_3", modifier => "&2", unit => "not supported,supported"},
        ...
        "06 MIDs supported (41-60)" => {
            command => "06 40",
            result  => [
                {
                    name => "Oxygen Sensor Heater Monitor Bank 1 - Sensor 1",
                    type => "bool_0",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                {
                    name => "Oxygen Sensor Heater Monitor Bank 1 - Sensor 2",
                    type => "bool_0",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
                {
                    name => "Oxygen Sensor Heater Monitor Bank 1 - Sensor 3",
                    type => "bool_0",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                {
                    name => "Oxygen Sensor Heater Monitor Bank 1 - Sensor 4",
                    type => "bool_0",
                    modifier => "&16",
                    unit     => "not supported,supported"
                },
                {
                    name => "Oxygen Sensor Heater Monitor Bank 2 - Sensor 1",
                    type => "bool_0",
                    modifier => "&8",
                    unit     => "not supported,supported"
                },
                {
                    name => "Oxygen Sensor Heater Monitor Bank 2 - Sensor 2",
                    type => "bool_0",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                {
                    name => "Oxygen Sensor Heater Monitor Bank 2 - Sensor 3",
                    type => "bool_0",
                    modifier => "&2",
                    unit     => "not supported,supported"
                },
                {
                    name => "Oxygen Sensor Heater Monitor Bank 2 - Sensor 4",
                    type => "bool_0",
                    modifier => "&1",
                    unit     => "not supported,supported"
                },
                ...
                {
                    name => "Oxygen Sensor Heater Monitor Bank 3 - Sensor 1",
                    type => "bool_1",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                {
                    name => "Oxygen Sensor Heater Monitor Bank 3 - Sensor 2",
                    type => "bool_1",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
                {
                    name => "Oxygen Sensor Heater Monitor Bank 3 - Sensor 3",
                    type => "bool_1",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                {
                    name => "Oxygen Sensor Heater Monitor Bank 3 - Sensor 4",
                    type => "bool_1",
                    modifier => "&16",
                    unit     => "not supported,supported"
                },
                {
                    name => "Oxygen Sensor Heater Monitor Bank 4 - Sensor 1",
                    type => "bool_1",
                    modifier => "&8",
                    unit     => "not supported,supported"
                },
                {
                    name => "Oxygen Sensor Heater Monitor Bank 4 - Sensor 2",
                    type => "bool_1",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                {
                    name => "Oxygen Sensor Heater Monitor Bank 4 - Sensor 3",
                    type => "bool_1",
                    modifier => "&2",
                    unit     => "not supported,supported"
                },
                {
                    name => "Oxygen Sensor Heater Monitor Bank 4 - Sensor 4",
                    type => "bool_1",
                    modifier => "&1",
                    unit     => "not supported,supported"
                },
...
#            {name => "", type => "bool_3", modifier => "&2", unit => "not supported,supported"},
        ...
        "06 MIDs supported (61-80)" => {
            command => "06 60",
            result  => [
                {
                    name     => "Heated Catalyst Monitor Bank 1",
                    type     => "bool_0",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Heated Catalyst Monitor Bank 2",
                    type     => "bool_0",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Heated Catalyst Monitor Bank 3",
                    type     => "bool_0",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Heated Catalyst Monitor Bank 4",
                    type     => "bool_0",
                    modifier => "&16",
                    unit     => "not supported,supported"
                },
...
#            {name => "", type => "bool_1", modifier => "&1", unit => "not supported,supported"},
                ...
                {
                    name     => "Secondary Air Monitor 1",
                    type     => "bool_2",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Secondary Air Monitor 2",
                    type     => "bool_2",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Secondary Air Monitor 3",
                    type     => "bool_2",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Secondary Air Monitor 4",
                    type     => "bool_2",
                    modifier => "&16",
                    unit     => "not supported,supported"
                },
...
#            {name => "", type => "bool_3", modifier => "&2", unit => "not supported,supported"},
        ...
        "06 MIDs supported (81-A0)" => {
            command => "06 80",
            result  => [
                {
                    name     => "Fuel System Monitor Bank 1",
                    type     => "bool_0",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Fuel System Monitor Bank 2",
                    type     => "bool_0",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Fuel System Monitor Bank 3",
                    type     => "bool_0",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Fuel System Monitor Bank 4",
                    type     => "bool_0",
                    modifier => "&16",
                    unit     => "not supported,supported"
                },
...
#            {name => "", type => "bool_3", modifier => "&2", unit => "not supported,supported"},
        ...
        "06 MIDs supported (A1-C0)" => {
            ...
            result  => [
                ...
                {
                    name     => "Misfire Cylinder 1 Data",
                    type     => "bool_0",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Misfire Cylinder 2 Data",
                    type     => "bool_0",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Misfire Cylinder 3 Data",
                    type     => "bool_0",
                    modifier => "&16",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Misfire Cylinder 4 Data",
                    type     => "bool_0",
                    modifier => "&8",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Misfire Cylinder 5 Data",
                    type     => "bool_0",
                    modifier => "&4",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Misfire Cylinder 6 Data",
                    type     => "bool_0",
                    modifier => "&2",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Misfire Cylinder 7 Data",
                    type     => "bool_0",
                    modifier => "&1",
                    unit     => "not supported,supported"
                },
                ...
                {
                    name     => "Misfire Cylinder 8 Data",
                    type     => "bool_1",
                    modifier => "&128",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Misfire Cylinder 9 Data",
                    type     => "bool_1",
                    modifier => "&64",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Misfire Cylinder 10 Data",
                    type     => "bool_1",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Misfire Cylinder 11 Data",
                    type     => "bool_1",
                    modifier => "&16",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Misfire Cylinder 12 Data",
                    type     => "bool_1",
                    modifier => "&8",
                    unit     => "not supported,supported"
                },
...
#            {name => "Vehicle manufacturer defined OBDMID FF", type => "bool_3", modifier => "&2", unit => ""},
        ...
        "Vehicle manufacturer defined OBDMID E1" => {
            command => "06 E1",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        "Vehicle manufacturer defined OBDMID E2" => {
            command => "06 E2",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        "Vehicle manufacturer defined OBDMID E3" => {
            command => "06 E3",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        "Vehicle manufacturer defined OBDMID E4" => {
            command => "06 E4",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        "Vehicle manufacturer defined OBDMID E5" => {
            command => "06 E5",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        "Vehicle manufacturer defined OBDMID E6" => {
            command => "06 E6",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        "Vehicle manufacturer defined OBDMID E7" => {
            command => "06 E7",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        "Vehicle manufacturer defined OBDMID E8" => {
            command => "06 E8",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        "Vehicle manufacturer defined OBDMID E9" => {
            command => "06 E9",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        "Vehicle manufacturer defined OBDMID EA" => {
            command => "06 EA",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        "Vehicle manufacturer defined OBDMID EB" => {
            command => "06 EB",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        "Vehicle manufacturer defined OBDMID EC" => {
            command => "06 EC",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        "Vehicle manufacturer defined OBDMID ED" => {
            command => "06 ED",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        "Vehicle manufacturer defined OBDMID EE" => {
            command => "06 EE",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        "Vehicle manufacturer defined OBDMID EF" => {
            command => "06 EF",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        "Vehicle manufacturer defined OBDMID F0" => {
            command => "06 F0",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        "Vehicle manufacturer defined OBDMID F1" => {
            command => "06 F1",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        "Vehicle manufacturer defined OBDMID F2" => {
            command => "06 F2",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        "Vehicle manufacturer defined OBDMID F3" => {
            command => "06 F3",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        "Vehicle manufacturer defined OBDMID F4" => {
            command => "06 F4",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        "Vehicle manufacturer defined OBDMID F5" => {
            command => "06 F5",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        "Vehicle manufacturer defined OBDMID F6" => {
            command => "06 F6",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        "Vehicle manufacturer defined OBDMID F7" => {
            command => "06 F7",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        "Vehicle manufacturer defined OBDMID F8" => {
            command => "06 F8",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        "Vehicle manufacturer defined OBDMID F9" => {
            command => "06 F9",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        "Vehicle manufacturer defined OBDMID FA" => {
            command => "06 FA",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        "Vehicle manufacturer defined OBDMID FB" => {
            command => "06 FB",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        "Vehicle manufacturer defined OBDMID FC" => {
            command => "06 FC",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        "Vehicle manufacturer defined OBDMID FD" => {
            command => "06 FD",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        "Vehicle manufacturer defined OBDMID FE" => {
            command => "06 FE",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
        "Vehicle manufacturer defined OBDMID FF" => {
            command => "06 FF",
            result  => [ { type => "word_0", modifier => "*1", unit => "" } ]
        },
...
"Emission-related diagnostic trouble codes detected during current or last completed driving cycle"
        ...
        "09 PIDs supported (01-20)" => {
            ...
            result    => [
                ...
                {
                    name     => "MessageCount CALID",
                    type     => "bool_0",
                    modifier => "&32",
                    unit     => "not supported,supported"
                },
                {
                    name     => "Calibration Identifications",
                    type     => "bool_0",
                    modifier => "&16",
                    unit     => "not supported,supported"
                },
                {
                    name     => "MessageCount CVN",
                    type     => "bool_0",
                    modifier => "&8",
                    unit     => "not supported,supported"
                },
...
#            {name => "09 PIDs supported (41-60)", type => "bool_3", modifier => "&1", unit => "not supported,supported"},
        ...
        "Vehicle Identification Number" => {
            command => "09 02",
            result  => [ { type => "string_1", modifier => "", unit => "" } ]
        },
        "MessageCount CALID" => {
            command => "09 03",
            result  => [ { type => "byte_0", modifier => "+0", unit => "" } ]
        ...
        "Calibration Verification Numbers" => {
            command => "09 06",
            result  => [ { type => "dword_0", modifier => "+0", unit => "" } ]
        },
        "MessageCount IPT" => {
            command => "09 07",
            result  => [ { type => "byte_0", modifier => "+0", unit => "" } ]
        ...
        "In-use Performance Tracking" => {
            ...
            result  => [
                {
                    name     => "OBD Monitoring Conditions Encountered Counts",
                    type     => "word_0",
                    modifier => "+0",
                    unit     => ""
                },
                {
                    name     => "Ignition Counter",
                    type     => "word_1",
                    modifier => "+0",
                    unit     => ""
                },
                {
                    name     => "Catalyst Monitor Completion Counts Bank 1",
                    type     => "word_2",
                    modifier => "+0",
                    unit     => ""
                },
                ...
                {
                    name     => "Catalyst Monitor Completion Counts Bank 2",
                    type     => "word_4",
                    modifier => "+0",
                    unit     => ""
                },
                ...
                {
                    name     => "O2 Sensor Monitor Completion Counts Bank 1",
                    type     => "word_6",
                    modifier => "+0",
                    unit     => ""
                },
                ...
                {
                    name     => "O2 Sensor Monitor Completion Counts Bank 2",
                    type     => "word_8",
                    modifier => "+0",
                    unit     => ""
                },
                ...
                {
                    name     => "EGR Monitor Completion Condition Counts",
                    type     => "word_10",
                    modifier => "+0",
                    unit     => ""
                },
                {
                    name     => "EGR Monitor Conditions Encountered Counts",
                    type     => "word_11",
                    modifier => "+0",
                    unit     => ""
                },
...
"AIR Monitor Conditions Encountered Counts (Secondary Air)",
                ...
                {
                    name     => "EVAP Monitor Completion Condition Counts",
                    type     => "word_14",
                    modifier => "+0",
                    unit     => ""
                },
                {
                    name     => "EVAP Monitor Conditions Encountered Counts",
                    type     => "word_15",
                    modifier => "+0",
                    unit     => ""
                }
        ...
        "ECUNAME" => {
            command => "09 0A",
            result  => [ { type => "string_0", modifier => "", unit => "" } ]
        },
...
sub PortOK {
    ...
    if ( $self->{'port'} == -1 ) {
        if ( $self->{'debug_level'} > 0 ) {
            print "Serial port not initialised!\n";
        }
        return 0;
    }
    else {
...
sub ShowReadableValues {
    ...
    print
"Values that the Read and Show functions can fetch from this vehicle:\n\n";

    while ( my ( $parameter_name, $definition ) = each %{ $self->{'get'} } ) {
        if ( exists( $definition->{'available'} )
...
sub Show {
    ...
    if ( $response->{'status'} eq "ok" ) {
        foreach my $result ( @{ $response->{'results'} } ) {
            print
"$result->{'address'} - $result->{'name'}: $result->{'value'} $result->{'unit'}.";
...
sub Read {
    ...
    if ( exists( $self->{'get'}->{$name} ) ) {
        if ( exists( $self->{'get'}->{$name}->{'available'} )
            && $self->{'get'}->{$name}->{'available'} == 1 )
        {
            ...
            elsif (substr( $command, 0, 2 ) eq "05"
                && substr( $command, 0, 5 ) ne "05 00" )
            {
                if ( defined($parameter) ) {
                    $command .= " ";
                    $command .= sprintf( "%02X", $parameter );
                    ...
                    $command .=
                      " 01";    # Default to O2Sensor = Bank 1 - Sensor 1.
                }
            }
            ...
            if ( $results->{'status'} ne "ok" ) {
                $results->{'status_message'} =
                  $self->{'status_meanings'}->{ $results->{'status'} };
                return $results;
            }

            if (   substr( $command, 0, 2 ) eq "06"
                && substr( $command, 0, 5 ) ne "06 00"
                && substr( $command, 0, 5 ) ne "06 20"
                && substr( $command, 0, 5 ) ne "06 40"
                && substr( $command, 0, 5 ) ne "06 60"
                && substr( $command, 0, 5 ) ne "06 80"
                && substr( $command, 0, 5 ) ne "06 A0"
                && substr( $command, 0, 5 ) ne "06 C0"
                && substr( $command, 0, 5 ) ne "06 E0"
                && $self->{'bus_type'} eq
                "CAN" )    # Command 6 works differently from 1,2,5,9 etc.
            {
                ...
                foreach my $result ( @{ $self->{'get'}->{$name}->{'result'} } )
                {
                    ...
                    if ( $type[$index] eq "AT" ) {
                        ...
                        if ( defined( $result->{'modifier'} ) ) {
                            ...
                            eval($statement)
                              ;    # Allow the use of a regex if required
                        ...
                        $value =
                          $self->GetResult( $type[$index],
                            $type[ $index + 1 ] );
                        if ( $self->{'debug_level'} > 2 ) {
                            print "GetResult value: $value\n";
                        }
                        ...
                        foreach $value ( @{ $self->{'command_results'} } ) {
                            ...
                            if ( $value ne "no result" ) {
                                    ...
                                    && $type[0] eq "signed" )
                                {
                                    ...
                                    $value =
                                      ( $value & $byte_value_mask ) -
                                      ( $value & $byte_sign_mask );
                                }
                                elsif ($type[$index] eq "word"
                                    && $type[0] eq "signed" )
                                {
                                    ...
                                    $value =
                                      ( $value & $word_value_mask ) -
                                      ( $value & $word_sign_mask );
                                }

                                if ( $type[$index] ne "string" ) {
                                    if ( $self->{'debug_level'} > 2 ) {
                                        print "$value $result->{'modifier'}\n";
                                    }
                                    $value =
                                      eval("$value $result->{'modifier'}");
                                    if ( $self->{'debug_level'} > 2 ) {
                                        print "$value\n";
                                    }
                                ...
                                push @{ $results->{'results'} },
                                  {
                                    name       => $id,
                                    value_read => $value,
                                    value   => $self->DecodeTroubleCode($value),
                                    unit    => $unit,
                                    address => ${ $self->{'command_addresses'} }
                                      [$iteration]
                                  };
                            }
                            else {
...
sub ShowTroubleCodes {
    ...
    my $malfunction_indicator_lamp_state =
      $number_of_codes & $malfunction_indicator_lamp_mask;
...
sub DecodeTroubleCode {
    ...
    if ( $self->{'debug_level'} > 1 ) {
        print
          "Code prefix: $code_prefix, Code: $code, Decoded: $decoded_code\n";
    }
    return $decoded_code;
}
...
sub WriteStoredDataByte {
    ...
    if ( $self->{'debug_level'} > 0 ) {
        print "~WriteStoredDataByte: $value\n";
    }
...
sub GetResult {
    ...
    if ( $self->{'debug_level'} > 1 ) {
        print "GetResult: Type: $type: Number: $number\n";
    }

    foreach my $address ( sort keys %{ $self->{'results'} } ) {
        my $number_of_result_bytes =
          $self->{'results'}->{$address}->{'response_length'};
        if ( $self->{'results'}->{$address}->{'command'} ==
               $self->{'last_command'}
            && $self->{'results'}->{$address}->{'sub_command'} ==
            $self->{'last_sub_command'} )
        {
            if ( $type eq "bool" ) {
                if ( $number_of_result_bytes < ( $number + 1 ) ) {
                    ...
                    $result =
                      ${ $self->{'results'}->{$address}->{'result'} }[$number];
                }
                ...
                if ( $number_of_result_bytes < ( ( $number * 2 ) + 2 ) ) {
                    if ( $self->{'debug_level'} > 2 ) {
                        print
                          "Number of result bytes: $number_of_result_bytes\n";
                    }
                    $result = "no result";
                }
                else {
                ...
                if ( $number_of_result_bytes < $number ) {
                    ...
                    foreach ( @{ $self->{'results'}->{$address}->{'result'} } )
                    {
                        if ( $number > 0 ) {
                            ...
                            if (   $_ > 32
                                && $_ < 127 )  # Ignore non-printable characters
                            {
                                $result .= chr($_);
                            }
                        }
    ...
    foreach ( @{ $self->{'response'} } ) {
        ...
        if ( scalar(@line_parts) > 2 ) {
            ...
            if ( length($address) < 3 ) {
                ...
                $self->{'results'}->{$address}->{'command'} =
                  ( hex( shift @line_parts ) & $command_mask );
                if ( $self->{'results'}->{$address}->{'command'} == 4 ) {
                    push( @line_parts, "00" );
                }
                if ( $self->{'results'}->{$address}->{'command'} ==
                    $command_mask )
                {
                    $self->{'results'}->{$address}->{'command'} =
                      ( hex( shift @line_parts ) );
                }
                if ( $has_sub_command[ $self->{'results'}->{$address}
                    ->{'command'} ] )
                {
                    $self->{'results'}->{$address}->{'sub_command'} =
                      hex( shift @line_parts );
                ...
                if ( $line_number <= 16 ) {
                    ...
                    $self->{'results'}->{$address}->{'command'} =
                      ( hex( shift @line_parts ) & $command_mask )
                      ;    # Error code will now be 63 rather than 7F
                    ...
                    if ( $line_number < 16 ) {
                            ...
                            $command_mask )
                        {
                            $self->{'results'}->{$address}->{'response_length'}
                              = $line_number -
                              2;  # Do not include command and sub-command bytes
                        }
                        else {
                            $self->{'results'}->{$address}->{'response_length'}
                              = $line_number - 1
                              ; # Do not include command byte (no sub-command byte)
                        }
                    }

                    if ( $self->{'results'}->{$address}->{'command'} == 4 ) {
                        push( @line_parts, "00" );
                    } # Command 04 only returns a 44 SID on success. Append a 0 byte to the result.

                    if ( $self->{'results'}->{$address}->{'command'} ==
                        $command_mask
                      ) # If there was an error, shift out the real command number.
                    {
                        $self->{'results'}->{$address}->{'command'} =
                          ( hex( shift @line_parts ) );
                        $self->{'results'}->{$address}->{'response_code'} =
                          $line_parts[0];
                    }
                    else {
                        if ( $has_sub_command[ $self->{'results'}->{$address}
            ...
            $self->{'results'}->{$address}->{'response_reason'} =
              $self->{'negative_response_codes'}
              ->{ $self->{'results'}->{$address}->{'response_code'} };
...
sub GetResultsCommand06_CAN {
    ...
    foreach my $address ( sort keys %{ $self->{'results'} } ) {
      ...
      #			my $obdmid_id = ${$self->{'results'}->{$address}->{'result'}}[$index];
            my $sdt_id =
              ${ $self->{'results'}->{$address}->{'result'} }[$index];
            my $uas_id =
              ${ $self->{'results'}->{$address}->{'result'} }[ $index + 1 ];

            my $test_value =
              ${ $self->{'results'}->{$address}->{'result'} }[ $index + 2 ] *
              256;
            $test_value +=
              ${ $self->{'results'}->{$address}->{'result'} }[ $index + 3 ];

            my $min_test_limit =
              ${ $self->{'results'}->{$address}->{'result'} }[ $index + 4 ] *
              256;
            $min_test_limit +=
              ${ $self->{'results'}->{$address}->{'result'} }[ $index + 5 ];

            my $max_test_limit =
              ${ $self->{'results'}->{$address}->{'result'} }[ $index + 6 ] *
              256;
            $max_test_limit +=
              ${ $self->{'results'}->{$address}->{'result'} }[ $index + 7 ];

            my $test_name = "Unrecognised test Id ($sdt_id)";

            if ( exists( $self->{'Standardized_Test_IDs'}->{$sdt_id} ) ) {
                $test_name =
                  $self->{'Standardized_Test_IDs'}->{$sdt_id}->{'name'};
            }
            ...
            if ( $uas_id >= 128 ) {
                ...
                $test_value =
                  ( $test_value & $word_value_mask ) -
                  ( $test_value & $word_sign_mask );
                $min_test_limit =
                  ( $min_test_limit & $word_value_mask ) -
                  ( $min_test_limit & $word_sign_mask );
                $max_test_limit =
                  ( $max_test_limit & $word_value_mask ) -
                  ( $max_test_limit & $word_sign_mask );
            }

            if ( exists( $self->{'unit_and_scaling_identifiers'}->{$uas_id} ) )
            {
                $unit =
                  $self->{'unit_and_scaling_identifiers'}->{$uas_id}->{'unit'};

                $test_value = eval(
"$test_value $self->{'unit_and_scaling_identifiers'}->{$uas_id}->{'modifier'}"
                );
                $min_test_limit = eval(
"$min_test_limit $self->{'unit_and_scaling_identifiers'}->{$uas_id}->{'modifier'}"
                );
                $max_test_limit = eval(
"$max_test_limit $self->{'unit_and_scaling_identifiers'}->{$uas_id}->{'modifier'}"
                );
            }
            ...
            push @{ $results->{'results'} },
              {
                ...
                name      => $test_name,
                value     => $test_value,
                max_limit => $max_test_limit,
                min_limit => $min_test_limit,
                unit      => $unit
              };
...
sub OpenPort {
    ...
    if ( defined($port_details) && $port_details ne "" ) {
        ...
        if ( $parameters[0] ne "" ) {
            ...
            if (
                $parameter ne "" ) # If a valid serial port name has been passed
            {
    ...
    do {
        ...
        $port_number++;
        $port_count++;
      } until ( ( $self->{'port'} != -1 && $self->{'ELM_type'} ne "NONE" )
          || $port_count > $max_ports_to_search );
...
sub FindAvailableCommands {
    ...
    if ( $self->{'bus_type'} eq "CAN" ) {
        push @commands,
          "06 MIDs supported (01-20)";   # Command only supported by CAN systems
    }
    else {
        push @commands, "05 TIDs supported (01-20)" ;
        # Command only supported by non-CAN systems

        # push @commands, "06 TIDs supported (01-20)";
        # Command only supported by non-CAN systems
    }
...
sub ProcessAvailableCommands {
    ...
    if ( $self->{'debug_level'} > 0 ) {
        print "~ProcessAvailableCommands: $command\n";
    }

    $self->{'get'}->{$command}->{'available'} =
      1;    # Flag the command as available
    ...
    if ( $response->{'status'} eq "ok" ) {
        foreach my $result ( @{ $response->{'results'} } ) {
            $self->{'get'}->{ $result->{'name'} }->{'available'} =
              $result->{'value'};
            if ( $self->{'debug_level'} > 1 ) {
                print
"$result->{'address'} - $result->{'name'}: $result->{'value'} $result->{'unit'}\n";
            ...
            if ( substr( $result->{'name'}, 4, 15 ) eq "IDs supported ("
                && $result->{'value'} == 1 )
            {
                ...
                && (
                    (
                        substr( $result->{'name'}, -2, 2 ) eq "13"
                        && $self->{'get'}->{'Location of oxygen sensors 13'}
                        ->{'available'} == 1
                    )
                    || ( substr( $result->{'name'}, -2, 2 ) eq "1D"
                        && $self->{'get'}->{'Location of oxygen sensors 1D'}
                        ->{'available'} == 1 )
                )
              )
            {
                my $new_name =
                  substr( $result->{'name'}, 0,
                    length( $result->{'name'} ) - 3 );
                ...
                if (   $result->{'name'} eq "Location of oxygen sensors 13"
                    || $result->{'name'} eq "Location of oxygen sensors 1D" )
                {
                    $self->{'get'}->{$new_name} =
    ...
    while (<REPLAYFILE>) {
        ...
        if ( $replay_state == $get_command ) {
            if ( substr( $_, 0, 1 ) eq "~" ) {
                ...
                for ( my $index = 1 ;
                    $index < $number_of_parameters ; $index++ )
                {
...
slightly modified and perl-tidied by Karl Hoskin 2020 to work in his "kawbs" system.
    https://github.com/khoskinhome/kawbs
